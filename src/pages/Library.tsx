  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-blue-600 via-indigo-500 to-indigo-600 p-6 md:p-8">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-gradient-to-br from-amber-500/10 to-transparent rounded-full blur-2xl animate-pulse" />
              ...
              <div className="space-y-3">
                ...
                <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 p-5 text-white group cursor-default">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-xs text-emerald-100/80 mt-1.5 leading-relaxed">Secure zero-trust portal with cryptographic provenance and automated citation.</p>
                  </div>
                </div>
              </div>
