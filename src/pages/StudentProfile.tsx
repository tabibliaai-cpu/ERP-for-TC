    ...
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] text-center p-10">
        ...
        <button 
          ...
          className="mt-8 px-6 py-3 bg-slate-900 text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:from-blue-700 hover:to-indigo-700 transition-all flex items-center gap-2"
        >
  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      <nav className="flex items-center gap-2 animate-in fade-in slide-in-from-top-4 duration-500">
        ...
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 italic-serif">
          Candidate Profile
        </span>
      </nav>
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex items-center gap-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-[32px] overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex items-center justify-center text-3xl font-bold shadow-2xl shadow-blue-200">
              {student.photoUrl ? (
            ...
            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-white rounded-2xl border-4 border-slate-50 flex items-center justify-center shadow-lg">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600">Student Profile</span>
            </div>
            ...
            <div className="flex items-center gap-4 mt-2">
              <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 rounded-full border border-slate-200">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">{student.program}</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 rounded-full border border-slate-200">
                <Calendar className="w-3.5 h-3.5 text-slate-400" />
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">Year {student.year}</span>
              </div>
              <span className={cn(
        ...
        <div className="flex flex-col items-end gap-3 text-right">
          <div className="flex items-center gap-2">
            <button 
              ...
              className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-slate-500 font-bold text-[10px] uppercase tracking-widest hover:text-blue-600 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-50 transition-all shadow-sm flex items-center gap-2"
              title="Print ID Card"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
        <div className="bg-white p-6 rounded-[32px] border border-slate-200/60 shadow-sm flex items-center gap-5">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">GPA Indicator</p>
        ...
        <div className="bg-white p-6 rounded-[32px] border border-slate-200/60 shadow-sm flex items-center gap-5">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Financial Standing</p>
      ...
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-300">
        ...
        {activeTab === 'academic' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden lg:col-span-2">
              <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
                <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Previous Educational Qualifications</h3>
              </div>
              <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Highest Qualification</p>
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Board / University</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.previousEducation?.boardOrUniversity || 'Unrecorded'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Year of Passing</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.previousEducation?.yearOfPassing || 'Unrecorded'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Marks / Grade</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.previousEducation?.marksOrGrade || 'Unrecorded'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Medium of Instruction</p>
            ...
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
              <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
                ...
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{subjects.length} Modules</span>
              </div>
              <div className="p-4 space-y-3">
                {subjects.length === 0 ? (
                  ...
                  subjects.map(subject => (
                    <div key={subject.id} className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-transparent hover:border-slate-200 transition-all group">
                      <div>
                      ...
                      <div className="text-right">
                        <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest">Active Enrollment</p>
            ...
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
              <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
                ...
                <button 
                  ...
                  className="px-4 py-2 bg-white text-blue-600 border border-slate-200 rounded-xl text-[10px] font-black uppercase tracking-widest hover:border-blue-200 hover:shadow-lg hover:shadow-blue-50 transition-all flex items-center gap-2"
                >
              ...
              <div className="p-4 space-y-3">
                {grades.length === 0 ? (
                  ...
                  grades.map(grade => {
                    ...
                    if (isEditing) {
                      return (
                        <div key={grade.id} className="p-4 bg-blue-50/50 rounded-2xl border border-blue-200 flex items-center justify-between">
                    ...
                    return (
                      <div key={grade.id} className="p-4 bg-slate-50/50 rounded-2xl border border-transparent flex items-center justify-between group">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            ...
                            <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">{percentage.toFixed(1)}% Score</p>
                          </div>
                          {canEditGrades && (
                            <button 
                              onClick={() => {
        ...
        {activeTab === 'financial' && (
          <div className="space-y-8">
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
              <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
                <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Financial Portfolio & Grants</h3>
              </div>
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Fee Structure Assigned</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.financial?.feeStructure || 'Standard'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Scholarship Status</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.financial?.hasScholarship ? 'Awarded' : 'None'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Payment Plan</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.financial?.paymentPlan || 'Monthly'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Account Standing</p>
                ...
                {student.financial?.sponsorshipDetails && (
                  <div className="lg:col-span-4 space-y-1 pt-4 border-t border-slate-100">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Sponsorship Details</p>
                    ...
                    transactions.map(tx => (
                      <tr key={tx.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="px-6 py-5">
                          <span className="text-[10px] font-black uppercase tracking-widest text-slate-500 bg-slate-100 px-2.5 py-1 rounded-md">{tx.type}</span>
                        </td>
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-1.5">
                            <div className={cn("w-1.5 h-1.5 rounded-full", tx.status === 'paid' ? "bg-emerald-500" : "bg-amber-500")} />
                            <span className={cn("text-[10px] font-black uppercase tracking-widest", tx.status === 'paid' ? "text-emerald-600" : "text-amber-600")}>{tx.status}</span>
                          </div>
                        </td>
                        <td className="px-6 py-5 font-mono text-[9px] text-slate-400 uppercase">
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {attendance.length === 0 ? (
                ...
                attendance.map(record => {
                  ...
                  return (
                    <div key={record.id} className="p-4 bg-slate-50/50 rounded-2xl border border-transparent flex items-center gap-4">
                      <div className={cn(
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          <p className="text-[9px] font-black uppercase tracking-widest text-slate-400">{record.date}</p>
        ...
        {activeTab === 'spiritual' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
              <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
                <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Spiritual Profile</h3>
              </div>
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Conversion Date</p>
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Baptized</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.spiritual?.isBaptized ? 'Yes' : 'No'}</p>
                </div>
                {student.spiritual?.isBaptized && (
                  <>
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Baptism Date</p>
                    ...
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Baptism Church</p>
                      <p className="font-bold text-slate-900 italic-serif">{student.spiritual?.baptismChurch || 'N/A'}</p>
                    </div>
                  </>
                )}
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Current Church</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.spiritual?.currentChurch || 'N/A'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Pastor Name</p>
                  <p className="font-bold text-slate-900 italic-serif">{student.spiritual?.pastorName || 'N/A'}</p>
                </div>
                <div className="md:col-span-2 space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Ministry Involvement</p>
                  <p className="font-bold text-slate-900 italic-serif leading-relaxed">{student.spiritual?.ministryInvolvement || 'N/A'}</p>
                </div>
                <div className="md:col-span-2 space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Spiritual Gifts</p>
                  <p className="font-bold text-slate-900 italic-serif leading-relaxed">{student.spiritual?.spiritualGifts || 'N/A'}</p>
                </div>
                <div className="md:col-span-2 space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Personal Testimony</p>
                  <p className="font-bold text-slate-900 italic-serif leading-relaxed bg-slate-50 p-4 rounded-2xl border border-slate-100">{student.spiritual?.testimony || 'N/A'}</p>
                </div>
              </div>
            </div>
            
            <div className="bg-slate-900 text-white rounded-[32px] border border-slate-800 shadow-sm overflow-hidden flex flex-col">
              <div className="p-8 border-b border-slate-800 bg-slate-800/30 flex items-center justify-between">
                <h3 className="text-lg font-bold text-white italic-serif uppercase tracking-widest">Calling & Ministry</h3>
              </div>
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8 flex-1">
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Divine Calling</p>
                  <p className="font-bold text-white italic-serif">{student.ministry?.isCalled ? 'Yes' : 'Pending Discernment'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Type of Calling</p>
                  <p className="font-bold text-white italic-serif">{student.ministry?.callingType || 'N/A'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Ministry Experience</p>
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Preferred Field</p>
                  <p className="font-bold text-white italic-serif">{student.ministry?.preferredField || 'N/A'}</p>
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Internship Interest</p>
        ...
        {activeTab === 'documents' && (
          <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
            <div className="p-8 border-b border-slate-100 bg-slate-50/30 flex items-center justify-between">
               <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Document Repository</h3>
            </div>
            <div className="p-8">
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-slate-50 border border-slate-100 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={cn("text-[10px] font-black uppercase tracking-widest mt-0.5", doc.url ? "text-emerald-500" : "text-amber-500")}>
                    ...
                    {doc.url ? (
                      ...
                      <button className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-blue-600 hover:border-blue-200 transition-all">
                        Upload
                      </button>
                    )}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-slate-100 bg-slate-50/30">
                  <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Personal Identification</h3>
                </div>
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Nationality</p>
                    <p className="font-bold text-slate-900 italic-serif">{student.nationality || 'Unrecorded'}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Aadhaar / National ID</p>
                    <p className="font-bold text-slate-900 italic-serif">{student.nationalId || 'Unrecorded'}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Passport Number</p>
                    <p className="font-bold text-slate-900 italic-serif">{student.passportNumber || 'N/A'}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Primary Phone</p>
                  ...
                  <div className="md:col-span-2 space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Current Residential Address</p>
              ...
              <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-slate-100 bg-slate-50/30">
                  <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest">Family & Background</h3>
                </div>
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Guardian Name</p>
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Religious Background</p>
              ...
              <div className="bg-white rounded-[32px] border border-slate-200/60 shadow-sm overflow-hidden">
                <div className="p-8 border-b border-slate-100 bg-slate-50/30">
                  <h3 className="text-lg font-bold text-slate-900 italic-serif uppercase tracking-widest text-rose-600">Medical Observations</h3>
                </div>
                <div className="p-8">
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Health Conditions & Notes</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Allergies</p>
                      <p className="font-bold text-slate-900 italic-serif">{student.allergies || 'None Recorded'}</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Disability</p>
            ...
            <div className="space-y-8">
              <div className="bg-slate-900 text-white rounded-[32px] p-8 shadow-xl shadow-slate-200 border border-slate-800">
                <h3 className="text-lg font-bold italic-serif uppercase tracking-widest mb-6 text-blue-400">Emergency Protocol</h3>
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-1">Relationship</p>
                      <p className="text-sm font-bold opacity-80">{student.emergencyContact?.relationship || 'Restricted'}</p>
                    </div>
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-1">Contact Dial</p>
                      <p className="text-sm font-bold opacity-80">{student.emergencyContact?.phone || 'UNRECORDED'}</p>
                    </div>
                  </div>
                  <div className="pt-4 border-t border-slate-800">
                    <p className="text-[9px] font-black uppercase tracking-[0.2em] text-amber-500 mb-2">Security Note</p>
      ...
      <AnimatePresence>
        {isEditModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="bg-white rounded-[40px] w-full max-w-2xl p-10 relative z-10 shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[90vh]">
              <div className="mb-8 flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 italic-serif uppercase">Edit Candidate Profile</h2>
                  <p className="text-xs text-slate-400 mt-1 uppercase tracking-widest">Digital provenance for institutional records.</p>
                </div>
              ...
              <div className="flex-1 overflow-y-auto space-y-8 pr-4 scrollbar-hide">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Student ID / Roll No.</label>
                    <input 
                      type="text" 
                      value={editData.studentId || ''}
                      onChange={e => setEditData({...editData, studentId: e.target.value})}
                      className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-3xl outline-none focus:bg-white focus:ring-4 focus:ring-blue-50 transition-all font-bold italic-serif"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Profile Photo URL</label>
                    <input 
                      type="url" 
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Current Gender</label>
                    <select 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Residential Provenance</label>
                  <textarea 
                    value={editData.address}
                    onChange={e => setEditData({...editData, address: e.target.value})}
                    rows={3}
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-3xl outline-none focus:bg-white focus:ring-4 focus:ring-blue-50 transition-all font-bold italic-serif resize-none"
                  />
                </div>

                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Program Designation</label>
                    <input 
                      type="text" 
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-4">Registry Status</label>
                    <select 
              ...
              <div className="mt-8 pt-8 border-t border-slate-50 flex justify-end gap-3">
                ...
                <button 
                  ...
                  disabled={isSaving}
                  className="px-10 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-3xl font-bold uppercase tracking-widest hover:bg-slate-900 transition-all shadow-xl shadow-blue-100 flex items-center gap-2"
                >
