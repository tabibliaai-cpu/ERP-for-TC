  ...
  return (
    <FormField label={label}>
      <div className="flex items-center gap-3">
        <label className="flex-1 flex items-center gap-3 cursor-pointer p-3 bg-slate-50 rounded-xl border border-dashed border-slate-200 hover:border-indigo-300 hover:bg-indigo-50/50 transition-all">
    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="border-b border-slate-100 pb-10">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600">Student Management</span>
